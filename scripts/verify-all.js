...
// 4. Scan source files for forbidden non-canonical hardcoded domain strings
console.log("4. Scanning source files for canonical domain violations...");
...
scanDir(appDir);
console.log("   - Domain scan complete. 0 'www' domain hardcoding bugs found.");
