  ...
  return (
    <div className="min-h-screen bg-[#F4F7FB] text-slate-800 flex flex-col font-sans">
      ...
      <main className="flex-grow max-w-4xl mx-auto w-full px-4 py-8 space-y-8">
        ...
        <div className="mb-6 p-3 bg-slate-50 border border-slate-200 rounded-2xl text-xs text-slate-700 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 shadow-2xs">
